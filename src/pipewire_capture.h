...
public:
  ...
  bool init(const std::string &source = "", int sample_rate = 44100,
...
private:
  ...
  static void onStreamState(void *ud, enum pw_stream_state old_s,
                            enum pw_stream_state new_s, const char *error);
};
